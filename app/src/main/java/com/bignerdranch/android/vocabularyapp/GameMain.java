...
public class GameMain extends AppCompatActivity {
    ...
    public void onBackPressed() {
        if(backPressedTime + 2000 > System.currentTimeMillis()){
            ...
            Toast.makeText(this, "Nhấp lại lần nữa để thoát", Toast.LENGTH_SHORT).show();
        }
    ...
    private void doValidate(Bundle savedInstanceState) {
        ...
        if(editText.getText().toString().equals(textAnswer)){
            Toast.makeText(GameMain.this, "Chính xác",Toast.LENGTH_SHORT).show();
            editText.setText("");
            currentAnswer++;
            numToGameOver = 0;
            isReloadBrick = true;
            ...
            Toast.makeText(GameMain.this, "Sai rồi",Toast.LENGTH_SHORT).show();
            editText.setText("");
            numToGameOver++;
            isReloadBrick = true;
            showGame(savedInstanceState);
