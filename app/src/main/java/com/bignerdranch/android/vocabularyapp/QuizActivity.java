...
public class QuizActivity extends AppCompatActivity {
    ...
    private void showNextQuestion() {
        ...
        if (questionCounter < questionCountTotal) {
            ...
            questionCounter++;
            textViewQuestionCount.setText("Câu số: " + questionCounter + " / " + questionCountTotal);
            answered = false;
    ...
    private void showSolution() {
        ...
        switch (currentQuestion.getTrueCase()) {
            case 1:
                ...
                textViewQuestion.setText("1 câu trả lời đúng");
                break;
            case 2:
                rb2.setTextColor(Color.GREEN);
                textViewQuestion.setText("2 câu trả lời đúng");
                break;
            case 3:
                rb3.setTextColor(Color.GREEN);
                textViewQuestion.setText("3 câu trả lời đúng\"");
                break;
        }
        if (questionCounter < questionCountTotal) {
